...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/03/16 17:24:15 by trambure          #+#    #+#             */
/*   Updated: 2026/03/30 13:40:35 by trambure         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    ClapTrap::beRepaired(unsigned int amount)
{
    ...
    {
        _hitPoints += amount;
        std::cout << "ClapTrap " << _name << " be repaired and earn "
        << amount << " hitPoints. Now it have " << _hitPoints << " hitPoints !"
        << std::endl;    
    }
}